// Serves social icons as SVG with custom fill color (for email signatures).
const PATHS = {
...
exports.handler = async (event) => {
  ...
  const svg = `<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path fill="${color}" d="${PATHS[name]}"/></svg>`;
